...
describe('v1.0.0 to v2.0.0', function () {
    ...
    describe('descriptions', function () {
        it('should correctly handle descriptions whilst converting from v1.0.0 to v2.0.0', function (done) {
    ...
    describe('request file body', function () {
        it('should correctly handle request file bodies whilst converting from v1.0.0 to v2.0.0', function (done) {
