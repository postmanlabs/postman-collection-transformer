...
describe('v1.0.0 to v2.1.0', function () {
    ...
    describe('handleBodyOptions', function () {
        it('should transform from v1 to v2.1 when dataOptions are not present', function (done) {
            transformer.convertSingle({
                id: '591dad6f-1067-4f1e-a51e-96f2c30cbcd9',
                dataMode: 'raw',
        ...
        it('should transform body options from v1 to v2.1', function (done) {
            transformer.convertSingle({
                id: '591dad6f-1067-4f1e-a51e-96f2c30cbcd9',
                dataMode: 'params',
                data: [{ key: 'foo', value: 'bar', enabled: false }],
        ...
        it('should transform {params to fromdata} body options from v1 to v2.1', function (done) {
            transformer.convertSingle({
                id: '591dad6f-1067-4f1e-a51e-96f2c30cbcd9',
                dataMode: 'params',
                data: [{ key: 'foo', value: 'bar', enabled: false }],
