...
describe('v2.1.0 ==> v2.0.0', function () {
    var converter = require('../../../lib/converters/v2.1.0/converter-v21-to-v2'),
    ...
    describe('sample conversions', function () {
        ...
        _.forEach(samples, function (sample, sampleName) {
            it('must create a valid v2.1.0 collection from ' + sampleName + '.json with synchronous API',
                function (done) {
                    var result,
