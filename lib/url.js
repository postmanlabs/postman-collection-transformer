...
const _ = require('lodash').noConflict(),
    ...
    unparseQueryParam = function (param) {
        ...
        // if the value is string, then we add the value
        (typeof param.value === STRING) && (unparsed += EQUALS + param.value);
    ...
    unparse: function (urlObj) {
        ...
        if (urlObj.auth) {
            ...
            if (typeof urlObj.auth.password === STRING) {
                ...
                authString += AUTH_SEGMENTS_SEPARATOR + urlObj.auth.password;
            }
