...
module.exports = {
     ...
     *
     * @todo: Think of a better/cleaner way to load converters, keeping future versions in mind
     * @note this form of loading is most likely not browser friendly, find browser alternative
     */
    converters: {
        'converter-v1-to-v2': require('./converters/v1.0.0/converter-v1-to-v2'),
        'converter-v1-to-v21': require('./converters/v1.0.0/converter-v1-to-v21'),
        'converter-v2-to-v1': require('./converters/v2.0.0/converter-v2-to-v1'),
        'converter-v2-to-v21': require('./converters/v2.0.0/converter-v2-to-v21'),
        'converter-v21-to-v1': require('./converters/v2.1.0/converter-v21-to-v1'),
        'converter-v21-to-v2': require('./converters/v2.1.0/converter-v21-to-v2')
    },
