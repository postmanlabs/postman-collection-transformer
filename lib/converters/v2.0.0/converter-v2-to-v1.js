...
_.assign(Builders.prototype, {
    ...
    dataOptions: function (item) {
        ...
        // Convert v2 formdata mode to v1 params mode
        if (bodyOptions.formdata) {
            bodyOptions.params = bodyOptions.formdata;
            delete bodyOptions.formdata;
        }
        // Convert v2 file mode to v1 binary mode
        if (bodyOptions.file) {
            bodyOptions.binary = bodyOptions.file;
            delete bodyOptions.file;
        }
