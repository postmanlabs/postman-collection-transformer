...
_.assign(Builders.prototype, {
    ...
    /**
     * Check for data disabled from a given Postman Collection V2 item
     *
     * @param {Object} item - .
     * @returns {*|number|string}
     */
    dataDisabled: function (item) {
        return _.get(item, 'request.body.disabled') === true ? true : undefined;
    },
    ...
    request: function (item, collectionId, skipResponses) {
        ...
        var units = ['headers', 'dataMode', 'dataDisabled', 'data', 'rawModeData',
