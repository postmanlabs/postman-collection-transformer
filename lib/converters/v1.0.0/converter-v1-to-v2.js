...
_.assign(Builders.prototype, {
    ...
    url: function (requestV1) {
        ...
        // return the objectified URL only if query param or path variable descriptions are present,
        // otherwise empty string if requestV1.url has null value, else the string
        return (parsed.query || parsed.variable) ? parsed :
            (parsed.raw || (_.isNull(requestV1.url) ? '' : requestV1.url));
    },
