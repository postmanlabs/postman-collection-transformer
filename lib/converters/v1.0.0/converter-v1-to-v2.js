...
_.assign(Builders.prototype, {
    ...
    singleItem: function (requestV1) {
        ...
        var self = this,
            ...
            variable = self.variable(requestV1, { retainIds: retainIds, noDefaults: self.options.noDefaults }),
            item = {
    ...
    itemGroups: function (collectionV1) {
        ...
        itemGroupCache = _.reduce(collectionV1.folders, function (accumulator, folder) {
            ...
            var retainIds = self.options.retainIds,
                ...
                variable = self.variable(folder, { retainIds: retainIds, noDefaults: self.options.noDefaults }),
                result = {
                    name: folder.name,
                    item: []
                };
...
module.exports = {
    ...
    convert: function (collection, options, callback) {
        ...
        var auth,
            ...
            varOpts = options && { fallback: options.env, retainIds: options.retainIds, noDefaults: options.noDefaults };
