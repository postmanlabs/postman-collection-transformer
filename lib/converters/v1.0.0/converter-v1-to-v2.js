...
_.assign(Builders.prototype, {
    ...
    singleResponse: function (responseV1) {
        ...
        // `protocolProfileBehavior` is not added in `self.request` since it is
        // added at `item` level for request. Add it explicitly for
        // response.originalRequest
        response.originalRequest && util.addProtocolProfileBehavior(originalRequest, response.originalRequest);
