...
_.assign(Builders.prototype, {
     ...
     *
     * @param {Object} entityV1 - The v1 compliant entity from which to extract variable definitions.
     * @param {Object} env - The environment that will override existing entity variables if passed.
     * @returns {*|Array}
     */
    variable: util.handleVars,
    ...
    event: function (entityV1) {
        ...
        if (_.isArray(entityV1.events)) {
            ...
            // @todo: Improve this to order prereuqest events before test events
    ...
    auth: function (entityV1) {
        ...
        var types = {
            ...
            type = types[entityV1.currentHelper] || entityV1.currentHelper,
            auth = {
                type: type
            };
        auth[type] = {};
        ...
        _.merge(auth[type], entityV1.helperAttributes && util.authMappersFromLegacy[entityV1.currentHelper] ?
            util.authMappersFromLegacy[entityV1.currentHelper](entityV1.helperAttributes) : {});
        return auth;
    },
...
module.exports = {
    ...
    convert: function (collection, options, callback) {
        ...
        var units = ['info', 'item', 'auth'],
            builders = new Builders(options),
            event = builders.event(collection),
            variable = builders.variable(collection, options && options.env),
            newCollection = {};

        variable && variable.length && (newCollection.variable = variable);
        event && (newCollection.event = event);
