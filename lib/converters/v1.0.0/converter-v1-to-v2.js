...
_.assign(Builders.prototype, {
    ...
    protocolProfileBehavior: function (requestV1) {
        var protocolProfileBehavior = requestV1.protocolProfileBehavior;

        return typeof protocolProfileBehavior === OBJECT ? protocolProfileBehavior : undefined;
    },
    ...
    singleItem: function (requestV1) {
        ...
        var self = this,
            units = ['request', 'response', 'protocolProfileBehavior'],
