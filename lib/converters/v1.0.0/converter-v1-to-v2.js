    ...
    parseFormData = function (data, retainEmpty) {
        ...
        for (i = 0, ii = data.length; i < ii; i++) {
            ...
            if (param.type === 'file' && param.value) {
                param.src = util.isString(param.value) ? param.value : null;
                delete param.value;
            }
...
_.assign(Builders.prototype, {
    ...
    body: function (requestV1) {
        ...
        if (util.isString(requestV1.rawModeData)) {
        ...
        // check if `rawModeData` is an array like: ['rawModeData']
            ...
            util.isString(requestV1.rawModeData[0])) {
        ...
        else if (!rawModeData && Array.isArray(requestV1.data)) {
            data.mode = 'formdata';
        }
        ...
        if (data.mode === 'raw') {
            ...
            else if (util.isString(requestV1.data)) {
