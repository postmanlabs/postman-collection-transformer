...
_.assign(Builders.prototype, {
    ...
    body: function (requestV1) {
        ...
        // at this point we are sure that its not emptyBody so let's
        // infer the data mode.
        // @note its possible that multiple types of body being set e.g, both
