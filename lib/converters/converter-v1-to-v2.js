...
_.extend(Builders.prototype, {
    ...
    info: function (collectionV1) {
        return {
            ...
            // jscs:enable
            description: (collectionV1.description === null) ? E : collectionV1.description,
    ...
    url: function (requestV1) {
        ...
        parsed.variable = util.merge(requestV1.pathVariableData, requestV1.pathVariables);
        return parsed;
    },
    ...
    header: function (requestV1) {
        ...
        // @todo: This logic does not account for headers with multiple values
        var headers = util.merge(requestV1.headerData, _parseHeaders(requestV1.headers));

        _.each(headers, function (header) {
            _.startsWith(header.key, headersCommentPrefix) && (header.disabled = true);
        });
    ...
    body: function (requestV1) {
        ...
        if (mode === 'raw') {
            ...
            data[mode] = _.isString(requestV1.rawModeData || requestV1.data) ?
                requestV1.rawModeData || requestV1.data : E;
        }
        else if (mode === 'file') {
            data.mode = mode;
    ...
    request: function (requestV1) {
        ...
        request.queryParams = requestV1.queryParams;
        return request;
    },
    ...
    singleItem: function (requestV1) {
        var self = this,
            ...
            item = {
                ...
                /* jshint ignore:end */ // jscs:enable
                name: requestV1.name || E,  // Inline building to avoid additional function call
