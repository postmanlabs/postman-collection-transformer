var _ = require('lodash'),
    ...
    builders = {
        ...
        body: function (requestV1) {
            ...
            if (mode === 'raw') {
                data[mode] = _.isString(requestV1.rawModeData) ? requestV1.rawModeData : '';
            }
            else {
        ...
        auth: function (requestV1) {
            ...
            if (_.isString(requestV1.helperAttributes)) {
                try {
                    ...
                    console.log('Error parsing helperAttributes for request: ', requestV1.name, e.stack || e);
                    requestV1.helperAttributes = {};
                }
            }
