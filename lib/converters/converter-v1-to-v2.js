...
_.extend(Builders.prototype, {
    ...
    itemGroups: function (collectionV1) {
        ...
        _.each(_.uniq(collectionV1.folders_order), function (folderId) {
...
module.exports = {
    ...
    /**
     * Returns a Builders object, for conversion of individual requests, responses, etc.
     *
     * @param options
     * @returns {Builders}
     */
    create: function (options) {
        return new Builders(options);
    },
