...
_.extend(Builders.prototype, {
    ...
    url: function (requestV1) {
        ...
        parsed.variables = _.map(requestV1.pathVariables, function (value, id) {
            return {
                value: value,
                id: id
            };
    ...
    headers: function (requestV1) {
        ...
        return _.map(_parseHeaders(requestV1.headers), function (value, key) {
            ...
            _.startsWith(key, headersCommentPrefix) && (header.disabled = true);
            return header;
        });
    },
    ...
    request: function (requestV1) {
        var self = this,
            units = ['url', 'method', 'headers', 'body', 'description'],
            request = {
    ...
    singleResponse: function (responseV1) {
        ...
        response.cookies = _.map(responseV1.cookies, function (cookie) {
    ...
    singleItem: function (requestV1) {
        var self = this,
            ...
            item = {
                ...
                events: self.itemEvent(requestV1)
            };
        units.map(function (unit) {
