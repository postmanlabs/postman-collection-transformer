...
_.extend(Builders.prototype, {
     ...
     * @returns {Object} An equivalent v1.0.0 representation for the current v2.0.0.1 request.
     */
    request: function (item, collectionId, skipResponses) {
        var _item = _.cloneDeep(item), // do not mutate the original
            auth = _.get(_item, 'request.auth');
        ...
        return Builders.super_.prototype.request.apply(this, [_item, collectionId, skipResponses]);
    }
});
...
module.exports = {
    ...
    convert: function (collection, options, callback) {
        ...
        var builders = new Builders(options),
            tempCollection = _.cloneDeep(collection),
        ...
        tempCollection = v2Common.populateIds(tempCollection);
        try {
            units.forEach(function (unit) {
                newCollection[unit] = builders[unit](tempCollection);
            });
        }
        catch (e) {
