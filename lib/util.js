...
module.exports = {
     ...
     * @param {Object} [modifiers.builder] - A set of abstraction functions for the current transformation operation.
    ...
    handleVars: function (entity, options, modifiers) {
        ...
        var self = this,
            ...
            isDescriptionHandlerValid = builder && typeof builder.description === 'function',
            ...
            result = _.map(source || fallback, function (item) {
                ...
                item.description && (description = isDescriptionHandlerValid ? builder.description(item.description) : item.description);
    ...
    /**
     *
     * @param {Object} entity - A container for the property value to be cleaned.
     * @param {Object} property - The name of the key whose value has to be sanitized.
     * @param {Object} [options] - A set of options for empty value cleaning.
     * @param {Boolean} [options.retainEmpty=false] - Sets falsy values to null when set to true.
     * @param {Object} [options.builder={}] - A set of abstraction helpers for the current transformation operation.
     * @returns {*}
     */
    cleanEmptyValue: function (entity, property, { retainEmpty = false, builder = {} }) {
        if (_.has(entity, property)) {
            if (entity[property]) {
                if (typeof builder[property] === 'function') {
                    entity[property] = builder[property](entity[property]);
                }
            }
            else {
