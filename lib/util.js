...
module.exports = {
     ...
     *
     * @param {Object} entity - A generic object that could contain the protocolProfileBehavior property.
     ...
     */
    addProtocolProfileBehavior: function (entity, destination) {
        if (!entity) { return; }

        if (typeof entity.protocolProfileBehavior === 'object') {
            destination && (destination.protocolProfileBehavior = entity.protocolProfileBehavior);
