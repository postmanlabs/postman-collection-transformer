...
util = {
     ...
     * @param path
     * @param data
     * @param pretty Controls whether the output is prettified.
     * @param callback
     */
    writeJSON: function (path, data, pretty, callback) {
        var json = (pretty) ? JSON.stringify(data, null, 4) : JSON.stringify(data);
