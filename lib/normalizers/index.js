...
module.exports = {
    ...
    normalize: function (collection, options, callback) {
        ...
        normalizers[version].normalize(collection, options, callback);
    },
    ...
    normalizeSingle: function (object, options, callback) {
        ...
        normalizers[version].normalizeSingle(object, options, callback);
    },
    ...
    normalizeResponse: function (response, options, callback) {
        ...
        normalizers[version].normalizeResponse(response, options, callback);
    }
};
