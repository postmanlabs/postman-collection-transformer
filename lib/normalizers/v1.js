...
_.assign(Builders.prototype, {
    ...
    request: function (requestV1, collectionId, skipResponses) {
        ...
        // normalized v1 requests should not have helperAttributes or currentHelper for normal
        if (requestV1.currentHelper && requestV1.currentHelper === 'normal') {
...
module.exports = {
    ...
    normalizeSingle: function (request, options, callback) {
        ...
        try { normalized = builders.request(_.cloneDeep(request)); }
        catch (e) { err = e; }
    ...
    normalizeResponse: function (response, options, callback) {
        ...
        try { normalized = builders.response(_.cloneDeep(response)); }
        catch (e) { err = e; }
