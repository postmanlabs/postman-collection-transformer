...
_.assign(Builders.prototype, {
    ...
    variables: function (entity, options) {
        ...
        return util.handleVars(entity, options || this.options);
    },
    ...
    data: function (requestV1) {
        ...
        _.isArray(requestV1.data) && _.forEach(requestV1.data, function (datum) {
            ...
            datum.description = self.description(datum.description);
    ...
    headerData: function (requestV1) {
        var self = this,
            retainEmpty = this.options && this.options.retainEmptyValues,
        ...
        normalizedHeaderData = _.map(requestV1.headerData, function (entity) {
            entity.description = self.description(entity.description);
    ...
    pathVariableData: function (entity, options) {
        ...
        results = _.map(results, function (item) {
            item.description = self.description(item.description);
    ...
    request: function (requestV1, collectionId, skipResponses) {
        ...
        requestV1.description = self.description(requestV1.description);
...
module.exports = {
    ...
    normalize: function (collection, options, callback) {
        ...
        collection.description = builders.description(collection.description);
