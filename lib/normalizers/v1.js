var _ = require('lodash').noConflict(),
     ...
     * @param {?Boolean} [options.retainEmptyValues=false] - When set to true, appropriate empty values are set to null
...
module.exports = {
     ...
     * @param {?Boolean} [options.retainEmptyValues=false] - When set to true, empty values are set to null instead of
     * being removed.
