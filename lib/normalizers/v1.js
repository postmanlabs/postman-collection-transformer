var _ = require('lodash').noConflict(),
     ...
     * @param {?Boolean} [options.nullifyEmptyValues=false] - When set to true, appropriate empty values are set to null
     * instead of being removed.
     * @returns {Object[]} - The normalized list of entities.
     */
    normalizeEntities = function (entities, options) {
        var nullify = options && options.nullifyEmptyValues;

        _.forEach(entities, function (entity) {
            if (_.has(entity, 'description') && !entity.description) {
                nullify ? (entity.description = null) : (delete entity.description);
            }
        });
...
_.assign(Builders.prototype, {
    ...
    request: function (requestV1, collectionId, skipResponses) {
        ...
        var map,
            ...
            nullifyEmpty = options.nullifyEmptyValues,
        ...
        if (_.has(requestV1, 'description') && !requestV1.description) {
            nullifyEmpty ? (requestV1.description = null) : (delete requestV1.description);
        }
    ...
    folders: function (collectionV1) {
        ...
        var auth,
            ...
            order,
            foldersOrder,
            nullifyEmpty = self.options.nullifyEmptyValues,
        ...
        _.forEach(collectionV1.folders, function (folder) {
            ...
            if (_.has(folder, 'description') && !folder.description) {
                nullifyEmpty ? (folder.description = null) : (delete folder.description);
            }
...
module.exports = {
     ...
     * @param {?Boolean} [options.nullifyEmptyValues=false] - When set to true, empty values are set to null instead of
     * being removed.
    ...
    normalize: function (collection, options, callback) {
        ...
        try {
            if (_.has(collection, 'description') && !collection.description) {
                nullifyEmpty ? (collection.description = null) : (delete collection.description);
            }
